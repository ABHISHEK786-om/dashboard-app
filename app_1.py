...
with dwn1:
    st.download_button("Get Data", data = data.to_csv().encode("utf8"),
...
with col5:
    fig = px.line(result, x="Month_Year", y="TotalSales", title="Total Sales Over Time",
                  template="gridon")
...
def format_sales(value):
    if value >= 0:
        return '{}:.2f'.format(value/1_000_00)
